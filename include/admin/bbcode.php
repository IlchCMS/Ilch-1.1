		...
		if(!isset($_POST['BB_SubmitButtons'])) {
			...
			db_query("UPDATE
						...
						SET
							...
							fnFormatBlock = '".$_POST['BBCode_BLOCK']."',
							...
							fnFormatImgUpl = '".$_POST['BBCode_IMGUPL']."',
