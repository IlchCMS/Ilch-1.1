...
if ($menu->get(1) == "confirm" AND isset($_GET['check'])) {
    ...
    if (db_num_rows($erg) == 1) {
        ...
        switch ($row['ak']) {
            ...
            # join us
            case 4 :
                echo '<br />Joinus kann über diese Liste nicht akzeptiert werden, mache diese über <a style="color:red;" href="http://' . $_SERVER['HTTP_HOST'] . '/admin.php?groups-joinus">Joinus Anfragen bearbeiten</a><br /><br />';
                break;
            # ak 5 remove account
            case 5:
