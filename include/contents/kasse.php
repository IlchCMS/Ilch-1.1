...
while ($r = db_fetch_assoc($erg)) {
  ...
  if (has_right(-8, 'kasse')) {
    $r['verwendung'] .= '<span style="float: right;"><a href="index.php?kasse-d'.$r['id'].'"><img src="include/images/icons/del.gif" border="0" title="'.$lang['delete'].'" alt="'.$lang['delete'].'" /></a></span>';
  }
  $tpl->set_ar_out($r, 1);
}
$tpl->out(2);
