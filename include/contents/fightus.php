...
if (count($far) == $x AND chk_antispam('fightus')) {
  ...
  # als upcoming war vormerken (kategorie 1)
	db_query("INSERT INTO prefix_wars (datime,`status`,gegner,tag,page,mail,skype,wo,tid,`mod`,game,mtyp,land,txt) VALUES ('".$datum."','1','".$clanname."','".$clantag."','".$clanpage."','".$mailaddy."','".$skype."','".$meetingplace."','".$squad."','".$xonx."','".$game."','".$matchtype."','".$clancountry."','".$message."')");
  # pm an den leader
