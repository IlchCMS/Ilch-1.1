...
static function getInstance(){static $obj;if(!$obj){$obj=new xajaxLanguageManager();}
return $obj;}
...
static function getInstance(){static $obj;if(!$obj){$obj=new xajaxArgumentManager();}
return $obj;}
...
static function getGlobalResponse(){static $obj;if(!$obj){$obj=new xajaxResponse();}
return $obj;}
...
function autoCompressJavascript($sJsFullFilename=NULL,$bAlways=false){$sJsFile='include/includes/xajax_js/xajax_core.js';if($sJsFullFilename){$realJsFile=$sJsFullFilename;}
...
function printJavascriptInclude(){$aJsFiles=$this->aJsFiles;$sJsURI=$this->sJsURI;if(0==count($aJsFiles)){$aJsFiles[]=array($this->_getScriptFilename('include/includes/xajax_js/xajax_core.js'),'xajax');if(true===$this->bDebug)
$aJsFiles[]=array($this->_getScriptFilename('include/includes/xajax_js/xajax_debug.js'),'xajax.debug');if(true===$this->bVerboseDebug)
$aJsFiles[]=array($this->_getScriptFilename('include/includes/xajax_js/xajax_verbose.js'),'xajax.debug.verbose');if(null!==$this->sLanguage)
$aJsFiles[]=array($this->_getScriptFilename('include/includes/xajax_js/xajax_lang_' . $this->sLanguage . '.js'),'xajax');}
