...
function initRTE(imgPath, incPath, css, genXHTML) {
	...
	//set paths vars
	imagesPath = 'include/images/icons/';
	includesPath = 'include/includes/js/rte/';
	cssFile = css;
...
function writeRichText(rte, html, width, height, buttons, readOnly) {
  ...
  */      
			...
			document.writeln('				<option value="Font" selected>[Schriftart]</option>');
			...
			document.writeln('			</select>');
			document.writeln('		</td>');
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'separator.gif" width="1" height="20" border="0" alt=""></td>');
			document.writeln('		<td>');
			document.writeln('			<select unselectable="on" id="fontsize_' + rte + '" onchange="selectFont(\'' + rte + '\', this.id);">');
			document.writeln('				<option value="Size">[Gr&ouml;sse]</option>');
			...
			document.writeln('		</td>');
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'separator.gif" width="1" height="20" border="0" alt=""></td>');
			document.writeln('		<td><div id="forecolor_' + rte + '"><img class="rteImage" src="' + imagesPath + 'textcolor.gif" alt="Text Farbe" title="Text Farbe" onClick="dlgColorPalette(\'' + rte + '\', \'forecolor\', \'\')"></div></td>');
			...
			document.writeln('	<tr>');
			document.writeln('		<td><img id="bold" class="rteImage" src="' + imagesPath + 'button.bold.gif" alt="Fett" title="Fett" onClick="rteCommand(\'' + rte + '\', \'bold\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'button.italic.gif" alt="Italic" title="Italic" onClick="rteCommand(\'' + rte + '\', \'italic\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'button.underline.gif" alt="Unterstrichen" title="Unterstrichen" onClick="rteCommand(\'' + rte + '\', \'underline\', \'\')"></td>');
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'separator.gif" width="1" height="20" border="0" alt=""></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'button.justifyleft.gif" alt="Linksb&uuml;ndig" title="Linksb&uuml;ndig" onClick="rteCommand(\'' + rte + '\', \'justifyleft\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'button.justifycenter.gif" alt="Zentriert" title="Zentriert" onClick="rteCommand(\'' + rte + '\', \'justifycenter\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'button.justifyright.gif" alt="Rechtsb&uuml;ndig" title="Rechtsb&uuml;ndig" onClick="rteCommand(\'' + rte + '\', \'justifyright\', \'\')"></td>');
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'separator.gif" width="1" height="20" border="0" alt=""></td>');

			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'button.insertorderedlist.gif" alt="Ordered List" title="Ordered List" onClick="rteCommand(\'' + rte + '\', \'insertorderedlist\', \'\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'button.insertunorderedlist.gif" alt="Unordered List" title="Unordered List" onClick="rteCommand(\'' + rte + '\', \'insertunorderedlist\', \'\')"></td>');
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'separator.gif" width="1" height="20" border="0" alt=""></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'button.link.gif" alt="Link einf&uuml;gen" title="Link einf&uuml;gen" onClick="dlgInsertLink(\'' + rte + '\', \'link\')"></td>');

      document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'button.image.gif" alt="Bild einf&uuml;gen" title="Bild einf&uuml;gen" onClick="dlgInsertImage(\'' + rte + '\', \'image\')"></td>');
			document.writeln('		<td><div id="table_' + rte + '"><img class="rteImage" src="' + imagesPath + 'insert_table.gif" alt="Tabelle einf&uuml;gen" title="Tabelle einf&uuml;gen" onClick="dlgInsertTable(\'' + rte + '\', \'table\', \'\')"></div></td>');
...
function dlgInsertImage(rte, command) {
	...
	parent.command = command;
	currentRTE = rte;
	InsertImage = popUpWin(includesPath + 'insert_image.php', 'InsertImage', 360, 180, '');
	
	//get currently highlighted text and set link text value
	setRange(rte);
	var imageText = '';
	if (isIE) {
		imageText = stripHTML(rng.htmlText);
	} else {
		imageText = stripHTML(rng.toString());
	}
...
function setImageText(imageText) {
	//set link text value in insert link dialog
	try {
		window.InsertImage.document.imageForm.imageText.value = imageText;
	} catch (e) {
		//may take some time to create dialog window.
		//Keep looping until able to set.
		setTimeout("setImageText('" + imageText + "');", 10);
	}
}
